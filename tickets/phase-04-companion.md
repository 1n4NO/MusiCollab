...
- Priority: P1 · Status: done · Dependencies: MC-011, MC-045
- Acceptance: User can enter a room code or use a shareable room URL; invalid room codes are rejected locally and the active room is visible.
...
- Priority: P1 · Status: done · Dependencies: MC-048
...
- Priority: P1 · Status: done · Dependencies: MC-045, MC-047
...
- Priority: P1 · Status: done · Dependencies: MC-032, MC-045
...
- Priority: P2 · Status: done · Dependencies: MC-048
...
- Priority: P2 · Status: done · Dependencies: MC-043
...
- Priority: P1 · Status: done · Dependencies: MC-044, MC-048
...
- Automated coverage is complete; final physical iPhone 6 Plus execution remains.
...
- Priority: P1 · Status: done · Dependencies: MC-119, MC-043
